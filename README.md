...
* Before you can run this sample, you must have the following prerequisites:
    ...
    * [Azure Cosmos Python SDK](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/cosmos/azure-cosmos) - Install with this command: `pip install --pre azure-cosmos`
